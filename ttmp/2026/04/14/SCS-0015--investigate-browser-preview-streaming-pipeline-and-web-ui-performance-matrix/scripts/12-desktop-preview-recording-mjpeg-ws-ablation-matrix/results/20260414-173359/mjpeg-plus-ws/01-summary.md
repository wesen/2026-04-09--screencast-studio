...
- metrics_dir: /home/manuel/code/wesen/2026-04-09--screencast-studio/ttmp/2026/04/14/SCS-0015--investigate-browser-preview-streaming-pipeline-and-web-ui-performance-matrix/scripts/12-desktop-preview-recording-mjpeg-ws-ablation-matrix/results/20260414-173359/mjpeg-plus-ws/metrics
- video_path: /home/manuel/code/wesen/2026-04-09--screencast-studio/ttmp/2026/04/14/SCS-0015--investigate-browser-preview-streaming-pipeline-and-web-ui-performance-matrix/scripts/12-desktop-preview-recording-mjpeg-ws-ablation-matrix/results/20260414-173359/mjpeg-plus-ws/output/Full Desktop.mov

## Metric deltas

~~~text
screencast_studio_eventhub_events_delivered_total{event_type="preview.state"}	delta=25
...
screencast_studio_eventhub_events_published_total{event_type="preview.state"}	delta=26
...
screencast_studio_preview_frame_updates_total{source_type="display"}	delta=26
screencast_studio_preview_http_bytes_served_total{source_type="display"}	delta=4641600
screencast_studio_preview_http_clients{source_type="display"}	last=1
screencast_studio_preview_http_flushes_total{source_type="display"}	delta=27
screencast_studio_preview_http_frames_served_total{source_type="display"}	delta=27
...
screencast_studio_websocket_events_written_total{event_type="preview.state"}	delta=25
