...
DOT_DIR="$RUN_DIR/dot"
BIN_PATH="$RUN_DIR/direct-full-desktop-harness-bin"

cd "$REPO_ROOT"
go build -o "$BIN_PATH" ./ttmp/2026/04/14/SCS-0016--investigate-low-level-performance-hot-path-with-pprof-perf-and-ebpf/scripts/15-go-direct-record-full-desktop-harness
