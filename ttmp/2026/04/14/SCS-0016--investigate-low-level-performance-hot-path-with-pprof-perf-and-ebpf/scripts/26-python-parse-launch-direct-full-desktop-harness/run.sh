...
OUTPUT_PATH="${OUTPUT_PATH:-$RUN_DIR/python-parse-launch-direct.${CONTAINER}}"
DOT_DIR="$RUN_DIR/dot"
...
---
Title: 26 python parse launch direct full desktop harness summary
Ticket: SCS-0016
Status: active
Topics:
    - screencast-studio
...
RelatedFiles: []
ExternalSources: []
Summary: Saved result summary for one Python parse-launch direct full-desktop control run.
LastUpdated: 2026-04-15T04:10:00-04:00
WhatFor: Preserve CPU and output measurements for the Python parse-launch hosting control.
WhenToUse: Read this when comparing Python-hosted full-desktop direct recording against Go and gst-launch controls.
---

# 26 python parse_launch direct full desktop harness
