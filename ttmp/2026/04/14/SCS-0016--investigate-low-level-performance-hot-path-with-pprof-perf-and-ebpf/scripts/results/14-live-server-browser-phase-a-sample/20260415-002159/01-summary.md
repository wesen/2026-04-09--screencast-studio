...
LastUpdated: 2026-04-15T00:22:10-04:00
...
- label: recording-only-browser-control-surface-one-tab-drained
- server_url: http://127.0.0.1:7777
- server_pid: 1004277
- avg_cpu: 552.90%
- max_cpu: 581.00%
- metrics_dir: /home/manuel/code/wesen/2026-04-09--screencast-studio/ttmp/2026/04/14/SCS-0016--investigate-low-level-performance-hot-path-with-pprof-perf-and-ebpf/scripts/results/14-live-server-browser-phase-a-sample/20260415-002159/metrics
...
screencast_studio_eventhub_events_delivered_total{event_type="telemetry.audio_meter"}	delta=151
...
screencast_studio_eventhub_events_published_total{event_type="telemetry.audio_meter"}	delta=151
...
screencast_studio_eventhub_publish_nanoseconds_total{event_type="telemetry.audio_meter"}	delta=4934126
screencast_studio_eventhub_publish_nanoseconds_total{event_type="telemetry.disk_status"}	delta=228276
...
screencast_studio_preview_http_streams_finished_total{source_type="display",reason="preview_gone"}	delta=0
...
screencast_studio_websocket_events_written_total{event_type="telemetry.audio_meter"}	delta=151
